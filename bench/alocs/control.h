...
int get_pair(TSTAMP_T idTx,KEY_T key,PAIR_T *pair);
 ...
 *O Bucket e identificado pelo sistema de Metadados baseado no intervalo de chaves*/
int put_pair(TSTAMP_T idTx,KEY_T key,char *value);
...
int remove_pair(TSTAMP_T idTx,KEY_T key);
